...
import { Calendar, Clock, Gauge, MapPin, Shield, PenTool as Tool } from "lucide-react";
...
const Cover = async ({ params }: Props) => {
  ...
  return car.images.length > 0 ? (
    <>
      ...
      />
      <CoverButtons carId={id} userId={user?.id} savedBy={car.savedBy} />
    </>
  ) : (
        ...
        <TabsContent value="details" className="mt-6">
          <Card>
            <CardContent className="p-6">
              ...
              <p className="text-gray-600 mb-6 mx-auto">{car.description}</p>
